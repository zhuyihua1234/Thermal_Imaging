...
imshow(temp_Plot,'Parent',axes(p_4),'InitialMagnification','fit');
colorbar;
...
ylabel('Change in Temperature (K)','FontWeight','bold');
...
imshow(temp_Plot,'Parent',axes(p_8),'InitialMagnification','fit');
colorbar;
colormap(gca,jet(65536)); % gca allow colormap to target current object
set(gca,'FontSize',14)
axis on;
